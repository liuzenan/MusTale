...
#import "MTConstants.h"
 ...
 NSString *const LATO_BLACK = @"Lato-Black";
 NSString *const LATO_BLACKITALIC = @"Lato-BlackItalic";
 NSString *const LATO_BOLD = @"Lato-Bold";
 NSString *const LATO_BOLDITALIC = @"Lato-BoldItalic";
 NSString *const LATO_HAIRLINE = @"Lato-Hairline";
 NSString *const LATO_HAIRLINEITALIC = @"Lato-HairlineItalic";
 NSString *const LATO_ITALIC = @"Lato-Italic";
 ...
 NSString * const FLAT_WHITE_COLOR = @"#ecf0f1";
